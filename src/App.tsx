...
import { ContributionOptimizerPage } from "./pages/ContributionOptimizerPage";
...
function ActiveView() {
  ...
  switch (activeView) {
    ...
    case "withdrawal-strategy":
      return <WithdrawalStrategyPage />;
    case "contribution-optimizer":
      return <ContributionOptimizerPage />;
  ...
  return (
    <AppShell>
      {loading ? (
        ...
        >
          <Typography
            sx={{ color: "var(--color-negative)", fontWeight: 600, mb: 0.5 }}
          >
